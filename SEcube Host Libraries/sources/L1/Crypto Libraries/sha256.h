/**
  ******************************************************************************
  * File Name          : sha256.h
  * Description        : Low level SHA-256 header file.
  ******************************************************************************
  *
...
/*! \file  sha256.h
 *  \brief This file defines what is needed for the SHA-256 algorithm. These functions are used exclusively to implement very low-level features in the SEcube SDK.
