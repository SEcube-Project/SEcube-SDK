/**
  ******************************************************************************
  * File Name          : aes256.h
  * Description        : Low level AES-256 header file.
  ******************************************************************************
  *
...
/*! \file  aes256.h
 *  \brief This file includes the definition of return values, constant parameters, and public functions used to implement AES algorithms. These functions are used exclusively to implement very low-level features in the SEcube SDK.
